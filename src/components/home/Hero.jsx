    ...
    return (
        <section className="mt-20 px-5 md:px-20 md:mt-10">
            <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
                <div className="lg:flex-grow w-full md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center">
                ...
                <div className="flex justify-center">
                    <NavLink to="/contacto" className="inline-flex items-center text-black border-0 py-2 px-6 rounded text-lg bg-gradient-to-r from-yellow-200 via-yellow-400 to-yellow-500 hover:bg-gradient-to-br focus:outline-none shadow-lg shadow-yellow-500/50"><span className='pe-1'>Contáctame</span><IconArrow/></NavLink>
                    <a href={downloadCv} download="/CV_Francisco-Soto-Flores.pdf" className="ml-4 inline-flex items-center text-white border border-yellow-500 py-2 px-6 focus:outline-none rounded text-lg"><span className='pe-1'>Descargar CV</span><IconDownload/></a>
                </div>
                </div>
