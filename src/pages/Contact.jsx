...
const Contact = () => {
  return (
    <section className="py-10 mx-7 my-40 flex items-center justify-center gap-20 flex-col md:flex-row md:mx-10 lg:mx-0">
        <form className="w-full bg-gray-100 md:order-2 rounded-lg py-16 px-10 lg:w-1/3">
            <div className="relative z-0 w-full mb-5 group">
                ...
                <label htmlFor="floating_email" className="peer-focus:font-medium absolute text-sm text-black  duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto peer-focus:text-blue-600 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">Nombre y Apellidos</label>
            </div>
            <div className="relative z-0 w-full mb-5 group">
            ...
            <div className="mx-auto">
              <label htmlFor="message" className="block mb-2 text-sm font-medium text-black">Mensaje</label>
